...
Changelog:
-2.2-
Added an option to remove the curly brackets in the design.
Changed author URI

-2.0-
Updated the theme customizer:

Added a logo upload option.
Added an option to display site title and description in the footer.
Added options for clickable header image and logo.
Advanced color options (unlimited colors).
Added options for the design details.
Added Sidebar position options.

Added a page template with no sidebar and one without sidebar, footer widget area and comments.
...
images/headers/ -contains header images.
languages/ -contains language files.
inc/ -contains the customizer file.
templates/ -contains template files.
css/ -contains the shadow and genericon style sheets.
font/ -contains genericon files.
...
Icons
Genericons are licensed under GPLv2. http://genericons.com/
